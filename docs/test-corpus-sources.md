...
| --- | --- | --- |
| OpenG Toolkit | BSD-3-Clause | via SourceForge `.vip` (a zip) → unzip → lvkit extract; not a git repo |
| JKISoftware/JKI-EasyXML | BSD-3-Clause | cases, nested dataflow, clusters, variants |
...
| --- | --- | --- |
| illuminated-g/lv-flex-channel-examples | MIT | `DAQmx AO/DAQ AO.vi` (+ .lvlib/.ctl) — real DAQmx-calling VI |
...
| Source | Reason |
| --- | --- |
| DAQmx-Digital-IO (Maxim-91/Digital-I-O-Control-based-on-NI-DAQmx-in-LabVIEW) | **no LICENSE → all-rights-reserved**; was removed from the corpus |
