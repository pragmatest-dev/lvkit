...
def _daqmx_entries() -> list[dict[str, Any]]:
    ...
    for vi, method, desc in [
        ...
        e.append(
            _entry(vi, f"{{task_in}}.{method}()", desc, [_TI, _TO4], _IMP_DAQ, _RP)
        )
    e.append(
        _entry(
            "DAQmx Clear Task.vi",
            "{task_in}.close()",
            "Clears (closes) the task.",
            [_TI],
            _IMP_DAQ,
        )
    )
    ...
    e.append(
        _entry(
            ...
            "{task_in}.ai_channels.add_ai_voltage_chan({physical_channel})",
            ...
            [
                ...
                _t(
                    "physical channels",
                    5,
                    "input",  # verified: In.vi
                    "physical_channel",
                ),
                _TO4,
                _t("task out", 15, "output", "task_out"),
            ],  # verified: In.vi
            _IMP_DAQ,
            _RP,
        )
    ...
    e.append(
        _entry(
            "DAQmx Read.vi",
            "{data} = {task_in}.read(number_of_samples_per_channel={num_samps})",
            "Reads samples from the task.",
            [
                _TI,
                _t("number of samples per channel", None, "input", "num_samps"),
    ...
    for suffix, desc in [
        ("Analog 1D DBL 1Chan NSamp", "Reads 1-chan analog 1D."),
        ("Analog 1D DBL NChan 1Samp", "Reads N-chan analog 1-samp."),
        ("Analog 2D DBL NChan NSamp", "Reads N-chan analog 2D."),
        ("Digital 1D Bool 1Chan 1Samp", "Reads 1-chan digital bool."),
        ("Digital 1D U32 1Chan NSamp", "Reads 1-chan digital U32."),
        ("Counter 1D DBL 1Chan NSamp", "Reads counter data."),
    ]:
    ...
    for suffix, desc in [
        ("Analog 1D DBL 1Chan NSamp", "Writes 1-chan analog 1D."),
        ("Analog 2D DBL NChan NSamp", "Writes N-chan analog 2D."),
        ("Digital 1D Bool 1Chan 1Samp", "Writes 1-chan digital bool."),
        ("Digital 1D U32 1Chan NSamp", "Writes 1-chan digital U32."),
    ]:
    ...
    chan_variants: list[tuple[str, str, list[dict], list[str]]] = [
        ("AI Voltage", "ai_channels.add_ai_voltage_chan", [_MN, _MX], ["AI Voltage"]),
        (
            "AI Current",
            "ai_channels.add_ai_current_chan",
            [_MN, _MX],
            ["AI Current", "AI Current RMS"],
        ),
        (
            "AI Thermocouple",
            "ai_channels.add_ai_thrmcpl_chan",
            [_MN, _MX],
            ["AI Temp TC"],
        ),
        ("AI RTD", "ai_channels.add_ai_rtd_chan", [_MN, _MX], ["AI Temp RTD"]),
        (
            "AI Strain Gage",
            "ai_channels.add_ai_strain_gage_chan",
            [_MN, _MX],
            ["AI Strain Gage"],
        ),
        (
            "AI Accelerometer",
            "ai_channels.add_ai_accel_chan",
            [_MN, _MX],
            ["AI Accelerometer"],
        ),
        ("AI Bridge", "ai_channels.add_ai_bridge_chan", [_MN, _MX], ["AI Bridge"]),
        (
        ...
        (
            "AI Force IEPE",
            "ai_channels.add_ai_force_iepe_chan",
            [_MN, _MX],
            ["AI Force IEPE"],
        ),
        (
            "AI Microphone",
            "ai_channels.add_ai_microphone_chan",
            [_MN, _MX],
            ["AI Microphone"],
        ),
        (
        ...
        (
            "AI Resistance",
            "ai_channels.add_ai_resistance_chan",
            [_MN, _MX],
            ["AI Resistance"],
        ),
        (
        ...
        ("AO Voltage", "ao_channels.add_ao_voltage_chan", [_MN, _MX], ["AO Voltage"]),
        ("AO Current", "ao_channels.add_ao_current_chan", [_MN, _MX], ["AO Current"]),
        ("AO FuncGen", "ao_channels.add_ao_func_gen_chan", [], ["AO FuncGen"]),
        ...
        ("CI Count Edges", "ci_channels.add_ci_count_edges_chan", [], ["CI Cnt Edges"]),
        ("CI Freq", "ci_channels.add_ci_freq_chan", [_MN, _MX], ["CI Freq"]),
        ("CI Period", "ci_channels.add_ci_period_chan", [_MN, _MX], ["CI Period"]),
        (
            "CI Pulse Width",
    ...
    for variant, method, extras, poly_names in chan_variants:
        ...
        params = ", ".join(
            f"{t['python_param']}={{{t['python_param']}}}" for t in extras
        )
    ...
    timing_variants: list[tuple[str, str, list[dict]]] = [
        (
            ...
            [
                ...
                _t("samples per channel", None, "input", "samps_per_chan"),
            ],
        ),
        (
            "Implicit",
    ...
    for variant, method, terms in timing_variants:
        ...
        params = ", ".join(
            f"{t['python_param']}={{{t['python_param']}}}" for t in terms
        )
    ...
    trig_variants: list[tuple[str, str, str, list[dict]]] = [
        ...
        ("None", "disable_start_trig", "Disables start trigger.", []),
    ]
    ...
    ref_trig: list[tuple[str, str, str, list[dict]]] = [
        (
            ...
            [
                _t("source", None, "input", "trigger_source"),
                _t("pretrigger samples", None, "input", "pretrigger_samples"),
            ],
        ),
        (
            "Analog Edge",
        ...
        ("None", "disable_ref_trig", "Disables reference trigger.", []),
    ]
    for variant, method, desc, terms in ref_trig:
        ...
        code = f"{{task_in}}.{full}({params})"
        e.append(_entry(vi, code, desc, [_CI] + terms + [_TO8], _IMP_DAQ, _RP))
    ...
    e.append(
        _entry(
            ...
            [_TI, _t("buffer size", None, "input", "buffer_size"), _TO4],
            _IMP_DAQ,
            _RP,
        )
    )
...
def _visa_entries() -> list[dict[str, Any]]:
    ...
    e.append(
        _entry(
            ...
            [
                _t("VISA resource name", None, "input", "visa_resource_name"),
    ...
    e.append(
        _entry(
            ...
            [
                _VI,
                _t("write buffer", None, "input", "write_buffer"),
                _VO,
                _t("return count", None, "output", "return_count"),
            ],
            _IMP_VISA,
            _VR,
        )
    ...
    e.append(
        _entry(
            ...
            [
                _VI,
                _t("byte count", None, "input", "byte_count"),
                _VO,
    ...
    e.append(
        _entry(
            ...
            "{find_list} = pyvisa.ResourceManager().list_resources({expression})",
    ...
    e.append(
        _entry(
            ...
            [_VI, _t("file path", None, "input", "file_path"), _VO],
            _IMP_VISA,
            _VR,
        )
    )
    ...
    e.append(
        _entry(
            ...
            [_VI, _VO, _t("status byte", None, "output", "status_byte")],
            _IMP_VISA,
            _VR,
        )
    )
    ...
    e.append(
        _entry(
            ...
            "Flushes I/O buffers.",
            [_VI, _t("mask", None, "input", "mask"), _VO],
            _IMP_VISA,
            _VR,
        )
    )
    e.append(
        _entry(
            ...
            [_VI, _t("timeout value (ms)", None, "input", "timeout_value"), _VO],
            _IMP_VISA,
            _VR,
        )
    )
    e.append(
        _entry(
            ...
            [
                ...
                _t("VISA resource name out", None, "output", "instr_out"),
            ],
            _IMP_VISA,
            _VR,
        )
    ...
    e.append(
        _entry(
            ...
            "{instr}.enable_event({event_type}, {mechanism})",
    ...
    e.append(
        _entry(
            ...
            "{instr}.disable_event({event_type}, {mechanism})",
...
def _serial_entries() -> list[dict[str, Any]]:
    ...
    return [
        _entry(
            "Serial Port Init.vi",
            "{ser_out} = serial.Serial(port={port}, baudrate={baud_rate})",
        ...
        _entry(
            ...
            [si, _t("bytes at port", None, "output", "bytes_at_port"), so],
            imp,
            sr,
        ),
        _entry(
...
def _ni_session_lifecycle(
    ...
    return [
        _entry(
            ...
            f"{{session_out}} = {pkg}.Session({{resource_name}})",
        ...
        _entry(
            ...
            [_SI, _SO, _t("result", None, "output", "result")],
            imp,
            _SR,
        ),
        _entry(
...
def _niscope_entries() -> list[dict[str, Any]]:
    ...
    e.append(
        _entry(
            ...
            [
                _SI,
                _t("min sample rate", None, "input", "min_sample_rate"),
                _t("min record length", None, "input", "min_num_pts"),
                _t("reference position", None, "input", "ref_position"),
                _t("number of records", None, "input", "num_records"),
                _t("enforce realtime", None, "input", "enforce_realtime"),
                _SO,
            ],
            imp,
            _SR,
...
def _nifgen_entries() -> list[dict[str, Any]]:
    ...
    e.append(
        _entry(
            ...
            [
                _SI,
                _t("waveform handle", None, "input", "waveform_handle"),
    ...
    e.append(
        _entry(
            ...
            "{waveform_handle} = {session}.create_waveform_numpy({waveform_data})",
            "Creates an arb waveform from data.",
            [
                _SI,
                _t("waveform data", None, "input", "waveform_data"),
                _SO,
                _t("waveform handle", None, "output", "waveform_handle"),
            ],
            imp,
            _SR,
        )
    ...
    e.append(
        _entry(
            ...
            "{session}.write_waveform({waveform_handle}, {waveform_data})",
    ...
    e.append(
        _entry(
            ...
            [_SI, _SO, _t("done", None, "output", "is_done")],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            [_SI, _t("script", None, "input", "script"), _SO],
            imp,
            _SR,
        )
    )
...
def _nidcpower_entries() -> list[dict[str, Any]]:
    ...
    e.append(
        _entry(
            ...
            [_SI, _t("voltage level", None, "input", "voltage_level"), _SO],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            [_SI, _t("current limit", None, "input", "current_limit"), _SO],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            [_SI, _t("current level", None, "input", "current_level"), _SO],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            [_SI, _t("voltage limit", None, "input", "voltage_limit"), _SO],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            [_SI, _t("output enabled", None, "input", "output_enabled"), _SO],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            "{session}.configure_aperture_time({aperture_time})",
            "Configures measurement aperture time.",
            [_SI, _t("aperture time", None, "input", "aperture_time"), _SO],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            f"{pfx} Measure.vi",
            ("{voltage}, {current}, {in_compliance} = {session}.measure()"),
            ...
            [
                ...
                _t("in compliance", None, "output", "in_compliance"),
            ],
            imp,
            _SR,
        )
    ...
    e.append(
        _entry(
            ...
            [_SI, _SO, _t("in compliance", None, "output", "in_compliance")],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            "{output_state} = {session}.query_output_state()",
            "Queries the output state.",
            [_SI, _SO, _t("output state", None, "output", "output_state")],
            imp,
            _SR,
        )
    )
...
def _nidmm_entries() -> list[dict[str, Any]]:
    ...
    e.append(
        _entry(
            ...
            [
                ...
                _t("range", None, "input", "range"),
                _t("resolution digits", None, "input", "resolution_digits"),
                _SO,
            ],
            imp,
            _SR,
    ...
    e.append(
        _entry(
            f"{pfx} Read.vi",
            "{reading} = {session}.read(maximum_time={max_time})",
    ...
    e.append(
        _entry(
            f"{pfx} Fetch.vi",
            "{reading} = {session}.fetch(maximum_time={max_time})",
    ...
    e.append(
        _entry(
            ...
            "{session}.configure_trigger(trigger_source={trigger_source})",
            "Configures trigger source.",
            [_SI, _t("trigger source", None, "input", "trigger_source"), _SO],
            imp,
            _SR,
        )
    )
    ...
    e.append(
        _entry(
            ...
            [
                ...
                _t("range", None, "input", "range"),
                _t("rate", None, "input", "rate"),
                _t("waveform points", None, "input", "waveform_points"),
                _SO,
            ],
            imp,
            _SR,
    ...
    e.append(
        _entry(
            ...
            "{waveform} = {session}.fetch_waveform(array_size={array_size})",
...
def _niswitch_entries() -> list[dict[str, Any]]:
    ...
    e.append(
        _entry(
            ...
            "{path_capability} = {session}.can_connect({channel1}, {channel2})",
            ...
            [
                ...
                _t("channel 2", None, "input", "channel2"),
                _SO,
                _t("path capability", None, "output", "path_capability"),
            ],
            imp,
            _SR,
        )
    ...
    e.append(
        _entry(
            ...
            "Sets a switch path.",
            [_SI, _t("path list", None, "input", "path_list"), _SO],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            "{session}.wait_for_debounce(maximum_time_ms={max_time})",
            "Waits for switches to settle.",
            [_SI, _t("maximum time", None, "input", "max_time"), _SO],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            "{session}.wait_for_scan_complete(maximum_time_ms={max_time})",
    ...
    e.append(
        _entry(
            ...
            "{count} = {session}.get_relay_count({relay_name})",
    ...
    e.append(
        _entry(
            ...
            "{position} = {session}.get_relay_position({relay_name})",
            "Gets relay position.",
            [
                _SI,
                _t("relay name", None, "input", "relay_name"),
    ...
    e.append(
        _entry(
            ...
            "{session}.relay_control({relay_name}, {relay_action})",
...
def _nidigital_entries() -> list[dict[str, Any]]:
    ...
    e.append(
        _entry(
            ...
            [_SI, _t("pin map file path", None, "input", "file_path"), _SO],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            [_SI, _t("pattern file path", None, "input", "file_path"), _SO],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            [
                _SI,
                _t(
                    "specifications file paths",
                    None,
                    "input",
                    "specifications_file_paths",
                ),
                _t("levels file paths", None, "input", "levels_file_paths"),
                _t("timing file paths", None, "input", "timing_file_paths"),
                _SO,
            ],
            imp,
            _SR,
    ...
    e.append(
        _entry(
            ...
            "{site_pass_fail} = {session}.burst_pattern(start_label={start_label})",
            "Bursts a digital pattern.",
            [
                _SI,
                _t("start label", None, "input", "start_label"),
                _SO,
                _t("site pass/fail", None, "output", "site_pass_fail"),
            ],
            imp,
            _SR,
        )
    ...
    e.append(
        _entry(
            ...
            "{site_pass_fail} = {session}.get_site_pass_fail()",
            "Gets per-site pass/fail results.",
            [_SI, _SO, _t("site pass/fail", None, "output", "site_pass_fail")],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            [_SI, _SO, _t("fail count", None, "output", "fail_count")],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            [_SI, _t("timeout", None, "input", "timeout"), _SO],
            imp,
            _SR,
        )
    )
    ...
    e.append(
        _entry(
            ...
            [
                _SI,
                _t("pin list", None, "input", "pin_list"),
                _t("measurement type", None, "input", "measurement_type"),
                _SO,
                _t("measurements", None, "output", "measurements"),
            ],
            imp,
    ...
    e.append(
        _entry(
            ...
            "{session}.pins[{pin_list}].ppmu_source({output_function})",
            "Sources voltage or current via PPMU.",
            [
                _SI,
                _t("pin list", None, "input", "pin_list"),
                _t("output function", None, "input", "output_function"),
                _SO,
            ],
            imp,
            _SR,
    ...
    e.append(
        _entry(
            ...
            [
                ...
                _t("samples to read", None, "input", "samples_to_read"),
                _SO,
                _t("waveform data", None, "output", "waveform_data"),
            ],
            imp,
            _SR,
        )
    ...
    e.append(
        _entry(
            ...
            "{session}.clock_generator_generate_clock(frequency={frequency})",
            "Generates a clock signal.",
            [_SI, _t("frequency", None, "input", "frequency"), _SO],
            imp,
            _SR,
        )
    )
    ...
    e.append(
        _entry(
            ...
            [_SI, _SO, _t("pin states", None, "output", "pin_states")],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            [_SI, _t("state", None, "input", "state"), _SO],
            imp,
            _SR,
        )
    )
    e.append(
        _entry(
            ...
            [_SI, _SO, _t("offsets", None, "output", "offsets")],
            imp,
            _SR,
        )
    )
...
def main() -> None:
    ...
    print(f"\nTotal: {total} driver mappings across {len(DRIVERS)} categories")
