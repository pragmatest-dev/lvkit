...
class StructureObject(RenderObject):
    ...
    def _glyph(self, theme: Theme):
        ...
        return structure_body_glyph(
            ...
            # Disable-family structures draw a DOTTED boundary EXCEPT a Type
            # Specialization Structure, which LabVIEW draws SOLID (#31/#46).
            dotted=(
                isinstance(rs.node, DisableStructureNode)
                and rs.node.kind is not DisableStructureKind.TYPE_SPEC
            ),
