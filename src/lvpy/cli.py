...
def main() -> int:
    ...
    if args.command == "convert":
        ...
        print(
            f"Error: 'lvpy {args.command}' has been removed."
            " Use 'lvpy generate' instead.",
            file=sys.stderr,
        )
        return 1
...
def cmd_convert(args: argparse.Namespace) -> int:
    """Handle the convert command — deprecated, use 'lvpy generate'."""
    print(
        "Error: 'lvpy convert' has been removed. Use 'lvpy generate' instead.",
        file=sys.stderr,
    )
    return 1
...
def cmd_graph(args: argparse.Namespace) -> int:
    """Handle the graph command — deprecated, use 'lvpy generate'."""
    print(
        "Error: 'lvpy graph' has been removed. Use 'lvpy generate' instead.",
        file=sys.stderr,
    )
    return 1
